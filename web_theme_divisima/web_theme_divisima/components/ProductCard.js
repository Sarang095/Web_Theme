...
class ProductCard extends NSProductCard {
    render() {
        ...
        if (product.variants_values?.filter(vv => vv.active).length) {
            hasVariants = true;
        }
                ...
                <div className="product-item">
                    <div className="pi-pic">
                        ...
                        <div className="pi-links">
                            {
                                hasVariants ? (
                                    <Link href={product_route.urls.href} as={product_route.urls.as}><a className="add-card"><i className="flaticon-bag"></i><span>{ t('product-card:choose') }</span></a></Link>
                                ) : (
                    ...
                    <div className="pi-text">
                        {
                            hasVariants ? (
                                <h6 className="price">{t('product-card:from')} {bestPrice.toFixed(2)} €</h6>
                            ) : (
                        ...
                        { !hasVariants && product.price.ati.special ? <del>{product.price.ati.normal.toFixed(2)} €</del> : null }
                    </div>
                </div>
                <ModalR
